...
public enum RewardShopItem {
    ...
    OUTFIT_NOVA(
            RewardItemType.OUTFIT,
            "Kurtka Nova",
            "Cyjanowa kurtka odkrywcy kodu.",
            600,
            1,
            0,
            0,
    ...
    OUTFIT_ORBIT(
            RewardItemType.OUTFIT,
            "Pancerz Orbitalny",
            "Rzadki strój odblokowywany w wyższej lidze.",
            1_800,
            15,
            0,
            0,
    ...
    ACCESSORY_HEADPHONES(
            ...
            "Słuchawki Focus",
            "Dodatek dla osób pracujących w pełnym skupieniu.",
            450,
            1,
            0,
            0,
    ...
    ACCESSORY_VISOR(
            RewardItemType.ACCESSORY,
            "Wizjer Debuggera",
            "Neonowy wizjer dla łowców błędów.",
            800,
            10,
            0,
            0,
    ...
    AURA_PULSE(
            RewardItemType.AURA,
            "Aura Puls",
            "Subtelna poświata rosnąca razem z ligą.",
            1_200,
            15,
            0,
            0,
    ...
    AURA_PRISM(
            RewardItemType.AURA,
            "Aura Pryzmat",
            "Najrzadsza, wielobarwna aura dla zaawansowanych.",
            3_000,
            40,
            0,
            0,

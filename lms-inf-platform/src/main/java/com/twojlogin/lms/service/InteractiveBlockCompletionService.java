...
public class InteractiveBlockCompletionService {
    ...
    public CompletionResult complete(
        ...
        if (block.getType() != BlockType.DIALOG
                ...
                && block.getType() != BlockType.LISTENING
        ...
        boolean completed = switch (block.getType()) {
            case DIALOG, VOCABULARY, LISTENING, WORD_LAB -> requiredItems > 0 && completedItems >= requiredItems && (block.getType() != BlockType.WORD_LAB || score >= MIN_PRONUNCIATION_SCORE);
